let projects = [
	{
		...
		name: 'Classics List',
		description:
			'Classics List is a book review website that offers a platform for book enthusiasts to share their reviews and engage with other like-minded individuals. The platform incorporates user profile management, allowing users to easily access and delete their reviews.',
		github: 'https://github.com/paigetetz/ClassicsList',
		demo: 'https://www.loom.com/share/a88fdd29cb104f6ab673dc0e3db5ac42',
		tech: 'React.js, Ruby on Rails, Vanilla CSS',
		images: [
	...
	},
	{
		...
		github: 'https://github.com/paigetetz/Wander',
		demo: 'https://www.loom.com/share/c77a4b18784a4f33990455231b19b4b9',
		tech: 'React.js, Ruby on Rails, Vanilla CSS',
		images: [
	...
	},
	{
		...
		name: 'Divr',
		description:
			'Divr is a website that allows users to research and plan their scuba diving experiences. Users can search for specific dive sites, as well as suggest new dive sites.',
		github: 'https://github.com/paigetetz/Divr',
		demo: 'https://www.loom.com/share/db4cce33c4bf484ea7aaca1a6b11ad06',
